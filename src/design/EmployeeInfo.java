...
public class EmployeeInfo extends EmployeeAbstract {
	 ...
	 */
	static String companyName, address;
	private String performance, pension;
	private String departments, name;
	private int bonus, salary;
	...
	public EmployeeInfo(String name, int employeeId, int age) {
		this.name = name;
		this.employeeId = employeeId;
		this.age = age;
	...
	public void worktime() {
		...
		System.out.println("Employees should work 6 hours on friday");
	}
